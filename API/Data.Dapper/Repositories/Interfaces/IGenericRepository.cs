...
namespace Data.Dapper.Repositories.Interfaces
{
    public interface IGenericRepository<T>
    {
        ...
        Task<IEnumerable<T>> GetByDynamicAsync(dynamic item, int pageNumber, int pageSize, string order, string table = null);
        ...
        Task<int> RowCount(dynamic item, string table = null);
    }
}
